      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="rounded-xl border border-line bg-white p-8">
            ...
            <div className="flex items-center gap-3 rounded-lg border border-brand/30 bg-brand-soft px-4 py-4">
...
export function Suite() {
  return (
    <section id="platform" className="scroll-mt-20 border-b border-line bg-white py-20 sm:py-28">
      <Container>
        <SectionHeading
          center
          eyebrow="The platform"
          title="One suite. Every essential tool."
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {modules.map((m) => (
            <div
              key={m.name}
              className="group rounded-xl border border-line bg-white p-6 transition-all hover:border-brand/40 hover:shadow-[0_12px_30px_-18px_rgba(37,99,235,0.4)]"
            >
    ...
    <section className="border-b border-line bg-surface py-20 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="A single sale flows through every module — automatically"
          sub="No exports, no copy-paste, no reconciliation. One action updates the whole business."
        />
      ...
      <Container>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2">
          {industries.map((ind) => (
            <div
              key={ind.slug}
              className="rounded-xl border border-line bg-white p-7 transition-all hover:border-brand/40"
            >
...
export function Why() {
  const rows = [
    ["Time to set up", "Months of evaluation", "Days, guided"],
  ...
  return (
    <section id="why" className="scroll-mt-20 border-b border-line bg-surface py-20 sm:py-28">
      <Container>
        ...
        />
        <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-xl border border-line bg-white">
          <div className="grid grid-cols-3 border-b border-line bg-surface text-sm font-semibold text-ink">
            ...
            <div className="p-4 text-brand">Simplifi AI</div>
          </div>
          {rows.map(([label, diy, simplifi]) => (
            <div key={label} className="grid grid-cols-3 border-b border-line text-sm last:border-0">
              ...
              <div className="p-4 font-medium text-ink">{simplifi}</div>
            </div>
          ))}
        </div>
      </Container>
...
export function AILayer() {
  const items = [
    ["Auto data entry", "Drop in a PO or invoice — Simplifi reads it and fills the records."],
    ...
    ["Ask anything", "Query every module in plain language: \"unpaid invoices over 60 days?\""],
  ];
  return (
    <section className="border-b border-line bg-white py-20 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="Your suite does the busywork"
          sub="An intelligence layer that spans every module — because it all lives in one place."
        />
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {items.map(([t, d]) => (
            <div key={t} className="rounded-xl border border-line bg-surface/40 p-6">
...
export function Security() {
  ...
  return (
    <section id="security" className="scroll-mt-20 border-b border-line bg-surface py-20 sm:py-28">
      <Container>
        <SectionHeading
...
export function Pricing() {
  return (
    <section id="pricing" className="scroll-mt-20 border-b border-line bg-white py-20 sm:py-28">
      <Container>
        <SectionHeading
          center
          eyebrow="Pricing"
        ...
        />
        <div className="mx-auto mt-12 max-w-md rounded-2xl border border-brand/30 bg-white p-8 shadow-[0_24px_60px_-30px_rgba(37,99,235,0.4)]">
          <p className="text-sm font-semibold text-brand">Simplifi Suite</p>
          ...
          <ul className="mt-6 space-y-3 text-sm text-ink-soft">
            {["All modules — CRM to Payroll", "Industry workflows for trade & manufacturing", "AI layer included", "Onboarding & migration support", "Enterprise security & SSO"].map(
              (f) => (
          ...
          <Button href="/demo" className="mt-8 w-full py-3 text-base">
            Talk to sales
          </Button>
        </div>
      </Container>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-ink px-8 py-16 text-center sm:px-16">
          ...
          <div className="relative">
            <h2 className="mx-auto max-w-2xl text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Run your whole business on one suite
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-lg text-white/70">
              Built for founders in export, import, trade and manufacturing.
              See Simplifi on your own workflows.
            </p>
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Button
                href="/signup"
                className="bg-brand px-6 py-3 text-base text-white hover:bg-brand-dark"
              >
                Get started free
              </Button>
            </div>
